...
This cursus is a cohort of peers who work, review each other's pull requests, and compete
on a shared leaderboard. The standards below set the tone for that. In this community, the
**Community Moderator** is the course instructor.
...
violation, contact the course instructor privately by email at **guilhem.busset@gmail.com**.
...
these values, enforcement actions are carried out in private with the involved parties, but
...
2. **Temporarily Limited Activities**
   ...
   2. Consequence: A private, written warning with a time-limited cooldown period designed
      to underscore the seriousness of the situation and give the community members
      involved time to process the incident. The cooldown period may be limited to
      particular communication channels or interactions with particular community members.
